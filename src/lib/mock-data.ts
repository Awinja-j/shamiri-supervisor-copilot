...
// Update MOCK_SESSIONS to reference these
export const MOCK_SESSIONS = [
  {
    id: '1',
    fellowId: '1',
    ...
    hasAnalysis: true,
    riskLevel: 'none' as const,
    transcript: MOCK_TRANSCRIPTS['1'], // Add this
  },
  {
    id: '2',
    fellowId: '2',
    ...
    hasAnalysis: true,
    riskLevel: 'none' as const,
    transcript: MOCK_TRANSCRIPTS['2'], // Add this
  },
  {
    id: '4',
    fellowId: '4',
    ...
    hasAnalysis: true,
    riskLevel: 'severe' as const,
    transcript: MOCK_TRANSCRIPTS['4'], // Add this
  },
  // ... add transcript field to all other sessions with placeholder text
];